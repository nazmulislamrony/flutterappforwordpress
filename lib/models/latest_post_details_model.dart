...
LatestPostdetails latestPostDetailsFromJson(String str) =>
    LatestPostdetails.fromJson(json.decode(str));

String latestPostDetailsToJson(LatestPostdetails data) =>
...
class LatestPostdetails {
  ...
  factory LatestPostdetails.fromJson(Map<String, dynamic> json) =>
      LatestPostdetails(
        link: json["link"],
